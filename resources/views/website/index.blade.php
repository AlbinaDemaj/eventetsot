...
@section('content')
    <section class="master-head d-flex align-items-center">
        <div class="container">
            <div class="caption">
                <h1>Easily Collect Photos<br>
                    <strong>From Every Guest <br>
                        At Your <span class="e-text-primary">Events</span> <img src="website/img/heart.svg">
                    </strong></h1>
                <p>Gather every photo & video from your guests into a
                    digital album, ready to share in a live slideshow
                    no apps, no hassle, so simple even grandma will use it.</p>
