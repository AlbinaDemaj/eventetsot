...
@section('content')
    ...
    <section class="internal-cta">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h1>Only about 5% of all the photos and videos snapped at weddings actually make their way to the newlyweds.</h1>
                ...
                <div class="col-md-6 mt-md-0 mt-5">
                    <img src="website/img/internal-cta.png" class="img-fluid">
                </div>
            </div>
        </div>
    </section>
