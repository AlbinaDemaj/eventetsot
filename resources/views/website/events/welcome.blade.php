...
@section('content')
    <div class="welcome-bg">
        <div class="center-card" style="background: url({{ asset('storage/' . $event->background) ?? asset('website/img/card-bg.png') }});">
            <div class="card-caption">
                ...
                <p class="{{ $event->is_animated ? 'animated-element-delay-2' : '' }}">
                    {{ $event->description ?: __('event_welcome.default_description') }}
                </p>
                <form>
