    ...
    <section class="contact-form">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-3">
                <div class="form-input">
                    <label for="fname">Ankesa apo Sygjerimi:</label>
                    <textarea type="text" id="fname" name="fname" rows="8" placeholder="Ankesa apo Sygjerimi"></textarea>
                </div>
                </div>
