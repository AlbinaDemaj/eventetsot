                ...
                <div className="hidden lg:block">
                    <div className="max-w-xl">
                        ...
                        <div className="mt-10 grid gap-4 sm:grid-cols-3">
                            <div className="rounded-[1.6rem] border border-[#EAE7FF] bg-white/78 px-5 py-5 text-center shadow-[0_10px_28px_rgba(15,23,42,0.05)] backdrop-blur">
                            ...
                            <div className="rounded-[1.6rem] border border-[#E2F2FF] bg-white/78 px-5 py-5 text-center shadow-[0_10px_28px_rgba(15,23,42,0.05)] backdrop-blur">
                            ...
                            <div className="rounded-[1.6rem] border border-[#FFE5EE] bg-white/78 px-5 py-5 text-center shadow-[0_10px_28px_rgba(15,23,42,0.05)] backdrop-blur">
                ...
                <div className="mx-auto w-full max-w-xl">
                    <div className="rounded-[2rem] border border-white/70 bg-white/78 p-8 shadow-[0_30px_90px_rgba(15,23,42,0.10)] backdrop-blur-2xl sm:p-10">
                        ...
                        <p className="mt-8 text-center text-sm text-slate-500">
                            ...
                            <a
                                href={footerLinkHref}
                                className="font-semibold text-[#7B61FF] hover:text-[#6b52ef]"
                            >
                                {footerLinkText}
                            </a>
                        </p>
