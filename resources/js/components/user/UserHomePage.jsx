export default function UserHomePage({ selectedEvent }) {
    ...
    return (
        <div className="space-y-5">
            <section className="relative -mt-5 overflow-hidden rounded-[38px] border border-[#ECE7FF] bg-[linear-gradient(135deg,#FFFFFF_0%,#F8F5FF_55%,#F2FAFF_100%)] p-6 shadow-[0_28px_80px_rgba(15,23,42,0.07)] sm:p-8">
                ...
                <div className="relative">
                    ...
                    <h2 className="mt-5 text-[34px] font-black leading-[1.02] tracking-[-0.06em] text-slate-950 sm:text-5xl">
                        Mirë se erdhe në EventetSot
                    </h2>

                    <p className="mt-5 max-w-3xl text-[15px] leading-8 text-slate-500 sm:text-[16px]">
                        Menaxho eventin, shpërndaje me të ftuarit dhe mblidh foto e video
                        në një vend.
                    </p>
                </div>
            </section>
